...
\end{tabular}
$$
For function def, the easier with the variable def.
$$
  \begin{tabular}{l}
    $T=\left\{\begin{array}{l}T_{0}, \quad \text { if }->\text { is present, } \\ \text { <None>, otherwise. }\end{array}\right.$                                   \\
